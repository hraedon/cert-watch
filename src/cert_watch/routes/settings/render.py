...
from cert_watch.config import LOCAL_ADMIN_AUTOGENERATED, setting_env_is_set
...
def _local_admin_configured(request: Request) -> bool:
    ...
    return bool(_get_settings(request).local_admin_user)
...
def _settings_context(
    ...
    *,
    ...
    env_hash_override = setting_env_is_set("local_admin_password_hash")
    autogenerated = local_admin and kv_get(db, LOCAL_ADMIN_AUTOGENERATED) == "1"

    from cert_watch.auth.rbac import load_ui_role_map

    ldap_role_map = load_ui_role_map(db)  # keyed by role id
