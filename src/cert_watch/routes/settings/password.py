...
from cert_watch.database import bump_session_version, get_write_lock, kv_set, kv_set_secret
...
async def change_local_admin_password(
    ...
    if setting_env_is_set("local_admin_password_hash"):
        return RedirectResponse(
    ...
    stored_hash = s.local_admin_password_hash
    if not stored_hash:
        return RedirectResponse(
    ...
    username = s.local_admin_user or "admin"
    with get_write_lock():
        # Revoke before the new credential is visible, and again below.
