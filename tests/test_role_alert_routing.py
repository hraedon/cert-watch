...
class TestRoleAlertGroupRouting:
    def test_role_scope_tag_routes_to_linked_group(self, db: Path):
        """A cert tagged 'epic' triggers an alert to a role's linked alert_group
        recipients when the role has scope_tags=epic + a linked alert_group,
        even with NO alert_group whose match_tags contains epic.
        """
    ...
    def test_role_routing_no_link_does_not_fire(self, db: Path):
    ...
    def test_role_routing_no_scope_tag_does_not_fire(self, db: Path):
    ...
    def test_role_routing_tag_mismatch_does_not_fire(self, db: Path):
    ...
    def test_role_routing_multi_tag_scope(self, db: Path):
    ...
    def test_evaluate_all_certs_includes_role_linked_recipients(self, db: Path):
    ...
    def test_role_routing_deduped_with_group_match(self, db: Path):
    ...
    def test_role_routing_inherited_host_tag(self, db: Path):
    ...
    def test_deleting_linked_alert_group_clears_role_link(self, db: Path):
